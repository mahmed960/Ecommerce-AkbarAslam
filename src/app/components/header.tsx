    ...
    <div className="flex h-24 items-center justify-between">
      ...
      <div className="flex-1 md:flex md:items-center md:gap-12">
        <a className="block text-teal-600" href="#">
          ...
          <Image src="https://www.akbaraslam.com/cdn/shop/files/Akbar_Aslam_Logo-small1_a93da462-6269-4282-a9a1-faa73161b336_225x@2x.png?v=1630557805" alt="" width={180} height={80}></Image>
